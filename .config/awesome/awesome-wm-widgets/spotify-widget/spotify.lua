...
local GET_CURRENT_SONG_CMD = 'sp metadata'
...
local function worker(args)
    ...
    local play_icon = args.play_icon or '/home/rishi/.config/awesome/themes/junerishi/icons/spotify_playing.png'
    local pause_icon = args.pause_icon or '/home/rishi/.config/awesome/themes/junerishi/icons/spotify_paused.png'
    ...
    local max_artist_length = args.max_artist_length or 20
    local max_song_length = args.max_song_length or 20
    local max_album_length = args.max_album_length or 20
    ...
    spotify_widget = wibox.widget {
        ...
        set_text = function(self, artist, album, track_num, song)
            local artist_to_display = ellipsize(artist, max_artist_length) .. ' [' .. ellipsize(album, max_album_length) .. ' | ' .. track_num .. '] '
            if self.artistw.text ~= artist_to_display then
                self.artistw.text = artist_to_display
            end
            local title_to_display = ' ' .. ellipsize(song, max_song_length)
