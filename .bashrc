...
alias xdim='xrandr --output HDMI2 --brightness 0.6 --output HDMI1 --brightness 0.6'
alias xnight='xrandr --output HDMI2 --gamma 1:1:0.6 --brightness 0.3 --output HDMI1 --gamma 1:1:0.6 --brightness 0.5'
alias xnorm='xrandr --output HDMI2 --brightness 1 --output HDMI1 --brightness 1'
